...
oatuh2_scheme = OAuth2PasswordBearer(tokenUrl="users/token")
...
async def get_current_user(token: str = Depends(oatuh2_scheme), db: AsyncSession = Depends(get_async_db)):
